...
public static class AsyncEventHandlerExtensions
{
    ...
    /// <typeparam name="TEventArgs">The type of the event data generated by the event.</typeparam>
    /// <returns>A <see cref="Task"/> representing the asynchronous execution of all event handlers.</returns>
    public static Task InvokeAllAsync<TEventArgs>(
        ...
        where TEventArgs : EventArgs
    {
        return Task.WhenAll(handler.GetHandlers().Select(handleAsync => handleAsync(sender, e, cancellationToken)));
    }
}