...
/// </summary>
/// <remarks>
///     <para>Conducted instances can opt in to the lifecycle by implementing any of the following
///     <see cref="IActivate" />, <see cref="IDeactivate" />, <see cref="IGuardClose" />.</para>
/// </remarks>
