...
namespace VacuumBreather.Mvvm.Lifecycle
{
    ...
    public static class ConductorExtensions
    {
        ...
        public static ValueTask CloseItemAsync(
        ...
        /// <returns>A <see cref="ValueTask" /> representing the asynchronous operation.</returns>
        public static ValueTask CloseItemAsync<T>(
        ...
        /// <typeparam name="T">The type of the conducted item.</typeparam>
        /// <returns>A <see cref="ValueTask" /> representing the asynchronous operation.</returns>
        public static async ValueTask DeactivateItemAsync<T>(
            this IConductor<T> conductor,
            T item,
            bool close,
            ...
            where T : class
        {
            ...
            if (close)
            {
                ICloseResult<T> closeResult = await conductor.CloseStrategy.ExecuteAsync(
                    new[] { item },
