...
namespace VacuumBreather.Mvvm.Lifecycle
{
    ...
    public static class ScreenExtensions
    {
        ...
        public static void DeactivateWith(this IDeactivate child, IDeactivate parent)
        {
            ...
            async ValueTask AsyncEventHandler(object sender, DeactivationEventArgs e,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                await activator.ActivateAsync(cancellationToken).ConfigureAwait(false);
            }
        }
        ...
        /// <param name="cancellationToken">(Optional) The cancellation token to cancel operation.</param>
        /// <returns>A <see cref="ValueTask" /> representing the asynchronous operation.</returns>
        public static async ValueTask TryDeactivateAsync(
