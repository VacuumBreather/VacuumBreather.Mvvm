...
{
    /// <summary>Configures the a host builder with a custom configuration function.</summary>
    /// <param name="hostBuilder">The host builder.</param>
    /// <param name="configure">The configuration function.</param>
    /// <returns>The configured <see cref="IHostBuilder"/>.</returns>
    internal static IHostBuilder ConfigureHostBuilder(this IHostBuilder hostBuilder,
