...
internal static class DataTemplateManager
{
    ...
    /// <summary>Gets or sets the logger for the <see cref="DataTemplateManager"/>.</summary>
    /// <value>The logger for the <see cref="DataTemplateManager"/>.</value>
    ...
    /// <summary>Creates data templates for view-models.</summary>
    /// <param name="resourceDictionary">The <see cref="IDictionary"/> to register the data templates in.</param>
    /// <param name="onRegister">A callback to execute whenever a data template was registered.</param>
    internal static void RegisterDataTemplates(IDictionary resourceDictionary, Action<DataTemplate> onRegister)
    {
        var defaultDataTemplate = CreateDefaultDataTemplate();
    ...
    {
        Logger.LogDebug(message: "Creating default data template for {ViewModel}", nameof(BindableObject));
