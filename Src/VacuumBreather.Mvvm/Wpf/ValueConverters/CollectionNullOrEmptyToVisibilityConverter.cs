...
/// <summary>
///     Converts the empty state of a collection to a visibility.
/// </summary>
...
{
    /// <summary>
    ///     Gets or sets the visibility that a non-null or empty collection is converted to.
    /// </summary>
    public Visibility NotNullOrEmptyVisibility { get; set; } = Visibility.Visible;

    /// <summary>
    ///     Gets or sets the visibility that a null or empty collection is converted to.
    /// </summary>
