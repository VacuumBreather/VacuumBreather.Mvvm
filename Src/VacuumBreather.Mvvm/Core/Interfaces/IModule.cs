...
/// <summary>Interface for a module extending the main application.</summary>
[PublicAPI]
public interface IModule
{
    /// <summary>Adds services of this module to the container.</summary>
    /// <param name="context">
...
/// <summary>Interface for a module extending the main application, configuring a specific container builder.</summary>
...
{
    /// <summary>Enables this module to configure the dependency injection container builder.</summary>
