...
/// <summary>
///     Provides a helper method to automatically handle ongoing asynchronous operations and their cancellation.
/// </summary>
[PublicAPI]
public static class AsyncHelper
{
    ...
    /// <summary>
    ///     Creates an awaitable and cancelable object which represents the asynchronous operation in the current scope. Use in
    ///     a using block or statement.
    /// </summary>
    /// <param name="cancellationToken">(Optional) An external cancellation token, which can be used to cancel the operation.</param>
    ...
    /// <param name="cancellationToken">(Optional) An external cancellation token, which can be used to cancel the operation.</param>
    /// <returns>
    ///     The <see cref="IAsyncOperation" /> representing the asynchronous operation in the current scope.
    /// </returns>
