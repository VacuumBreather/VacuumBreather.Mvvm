...
public sealed class AsyncGuard
{
    ...
    /// <summary>Gets a value indicating whether any asynchronous operations are still ongoing (i.e. using tokens).</summary>
    ...
    /// <summary>
    ///     Gets a new token to track an asynchronous operation. Use as the <see cref="IDisposable"/> with
    ///     <see cref="ValueTaskExtensions.Using"/>.
    /// </summary>
