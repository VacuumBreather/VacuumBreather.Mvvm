...
/// <summary>Event arguments for the <see cref="IDeactivate.Deactivating"/> <see cref="IDeactivate.Deactivating"/> events.</summary>
public class DeactivatingEventArgs : EventArgs
{
    /// <summary>Initializes a new instance of the <see cref="DeactivatingEventArgs"/> class.</summary>
