...
/// <summary>Event arguments for the <see cref="IDeactivate.Deactivating"/> <see cref="IDeactivate.Deactivated"/> events.</summary>
public class DeactivationEventArgs : EventArgs
{
    /// <summary>Initializes a new instance of the <see cref="DeactivationEventArgs"/> class.</summary>
