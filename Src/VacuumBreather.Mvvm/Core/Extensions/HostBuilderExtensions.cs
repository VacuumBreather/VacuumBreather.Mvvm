...
/// <summary>Provides extension methods for the <see cref="IHostBuilder"/> type. types.</summary>
public static class HostBuilderExtensions
{
    /// <summary>Registers a module and allows it to add its services to the dependency injection container.</summary>
    ...
    /// <summary>
    ///     Registers a module and allows it to add its services to the dependency injection container. This overload
    ///     allows the module direct access to the underlying container builder.
    /// </summary>
